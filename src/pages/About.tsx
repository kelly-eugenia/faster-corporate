    ...
    <>
      ...
      <div className="w-full mx-auto">
        ...
        <div className="xl:max-w-[1920px] mx-auto">
          {/* What we do */}
          <section className="rounded-2xl -mt-32 md:-mt-48 mb-8 px-8 sm:px-12 lg:px-32 xl:px-40 py-8 sm:py-12 pb-6 content-center">
            {/* Image */}
            <motion.div
              initial={{ opacity: 0, y: 80 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="overflow-hidden">
                <img
                  src={TeamPhoto}
                  alt="The Faster team"
                  className="block rounded-2xl w-full max-h-[800px] object-cover"
                />
              </div>
            </motion.div>
          ...
          {/* Trustpilot */}
          <section className="rounded-2xl mx-8 sm:mx-12 lg:mx-32 xl:mx-40 px-6 py-8 md:py-12 mb-12 md:mb-24 bg-bg-secondary text-xl text-center text-bg-primary">
        ...
        <section className="bg-bg-secondary px-8 sm:px-12 lg:px-16 xl:px-40 py-8 md:py-16 mb-12 gap-8 content-center">
          <div className="xl:max-w-[1920px] mx-auto">
                  ...
                  <div className="-mx-8 px-8">
                    <div className="flex overflow-x-auto gap-4 pb-4 snap-x snap-mandatory">
                      ...
                      <div className="snap-start shrink-0 w-[80%] bg-bg-primary rounded-2xl p-8 flex flex-col justify-start">
                        ...
                        <p>
                          All our fees are explained before you commit — no
                          hidden costs.
                        </p>
                      </div>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 bg-gradient-to-tr from-primary to-secondary rounded-2xl px-8 sm:px-16 mb-12 gap-2 sm:gap-16 content-center">
              ...
              <div className="order-1 lg:order-2 text-center lg:text-left py-12 lg:py-16 pb-0 content-center">
                ...
                <h1 className="mt-8 lg:mt-12 my-6 md:my-8 text-4xl sm:text-5xl lg:text-6xl text-bg-primary">
                  How we're{" "}
                  <span className="text-bg-secondary font-[800]">
                    different
                  </span>
                </h1>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-2 bg-bg-primary rounded-2xl px-8 sm:px-16 mb-12 gap-8 sm:gap-16 content-center">
              <div className="lg:text-left text-center py-12 lg:py-16 pb-0 content-center">
                ...
                <ul className="list-inside text-base md:text-lg font-medium text-text-primary">
                  ...
                  <li className="my-2 md:my-4 relative pl-4 lg:pl-8 list-none before:absolute before:left-0 before:content-['✓'] before:text-primary">
                    Compliant with Australian credit laws and privacy
                    requirements
                  </li>
                  <li className="my-2 md:my-4 relative pl-4 lg:pl-8 list-none before:absolute before:left-0 before:content-['✓'] before:text-primary">
                    Committed to responsible lending through careful assessment
