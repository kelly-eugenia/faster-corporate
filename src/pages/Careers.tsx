  ...
  return (
    <>
      ...
      <div className="w-full mx-auto">
        ...
        {/* Why work here */}
        <section
          className="lg:-mx-40 sm:-mx-12 lg:px-40 sm:px-12 lg:py-16 md:py-12 content-center bg-cover bg-top"
        ...
        >
          ...
          <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 items-stretch">
            ...
            <div className="bg-bg-secondary rounded-2xl p-8 content-center">
              ...
              <h2>Flexible work</h2>
              <p>
                Enjoy flexible, hybrid work that works best for you — balancing
                focus time at home with collaboration in the office.
              </p>
            </div>
          </div>
        </section>
