                ...
                {FAQ_GROUPS.map((g) => {
                  ...
                  return (
                    <button
                      ...
                      className={`text-center rounded-card text-wrap p-[14px_16px] sm:p-[18px_20px] flex flex-col gap-1.5 sm:gap-2.5 border transition-all
                        ${
                          isActive
                    ...
                    >
                      <span
                        className={`w-7 h-7 sm:w-9 sm:h-9 rounded-[10px] inline-flex items-center justify-center border transition-colors
                          ${
                            isActive
                      ...
                      <span
                        className={`text-[14px] sm:text-[18px] font-bold tracking-[-0.01em] leading-[1.3] ${
